...
- Phase E5 inline handler cleanup is not safe as a one-shot change: current audit still shows 159 inline handlers and 31 local classic scripts after E5.9. Replace handlers one island at a time only after a browser/mobile QA loop.
