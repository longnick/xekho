...
const DEFAULT_MENU = [
  ...
  { id: 'm02', name: 'Khô cá chỉ vàng', category: 'Khô Nướng', price: 25000, unit: 'phần', cost: 14000, ingredients: [{name:'Khô cá chỉ vàng',qty:1,unit:'phần'}] },
  { id: 'm03', name: 'Khô cá thiều tâm', category: 'Khô Nướng', price: 30000, unit: 'phần', cost: 18000, ingredients: [{name:'Khô cá thiều tâm',qty:1,unit:'phần'}] },
  { id: 'm04', name: 'Khô cá bống', category: 'Khô Nướng', price: 25000, unit: 'phần', cost: 14000, ingredients: [{name:'Khô cá bống',qty:1,unit:'phần'}] },
  ...
  // COMBO
  { id: 'm15', name: 'Combo 1', category: 'Phần Combo', price: 149000, unit: 'phần', cost: 90000, ingredients: [{name:'Mực khô',qty:0.5,unit:'phần'},{name:'Khô cá chỉ vàng',qty:1,unit:'phần'},{name:'Khô cá thiều tâm',qty:1,unit:'phần'},{name:'Lạp xít',qty:1,unit:'phần'}] },
  { id: 'm16', name: 'Combo 2', category: 'Phần Combo', price: 199000, unit: 'phần', cost: 125000, ingredients: [{name:'Mực khô',qty:1,unit:'phần'},{name:'Khô cá chỉ vàng',qty:1,unit:'phần'},{name:'Khô cá đuôi',qty:1,unit:'phần'},{name:'Khô cá bò',qty:1,unit:'phần'},{name:'Lạp xít',qty:1,unit:'phần'}] },
  { id: 'm17', name: 'Combo 3', category: 'Phần Combo', price: 249000, unit: 'phần', cost: 160000, ingredients: [{name:'Mực khô',qty:1,unit:'phần'},{name:'Khô cá đuôi',qty:1,unit:'phần'},{name:'Lạp xít',qty:1,unit:'phần'},{name:'Khô cá đao',qty:1,unit:'phần'},{name:'Gỏi xoài',qty:1,unit:'phần'},{name:'Vịt lộn',qty:2,unit:'trứng'}] },
  ...
  { id: 'm24', name: 'Trứng bắc thảo củ kiệu tôm khô', category: 'Món Ăn Kèm', price: 70000, unit: 'phần', cost: 40000, ingredients: [{name:'Trứng bắc thảo',qty:2,unit:'trứng'},{name:'Củ kiệu',qty:50,unit:'g'},{name:'Tôm khô',qty:30,unit:'g'}] },
  { id: 'm25', name: 'Khoai tây lắc phô mai', category: 'Món Ăn Kèm', price: 50000, unit: 'phần', cost: 28000, ingredients: [{name:'Khoai tây',qty:300,unit:'g'},{name:'Phô mai bột',qty:20,unit:'g'}] },
...
const DEFAULT_INVENTORY = [
  ...
  { id:'i03', name:'Khô cá thiều tâm', qty:40, unit:'phần', minQty:8, costPerUnit:18000 },
  ...
  { id:'i16', name:'Cá sun sin', qty:3, unit:'kg', minQty:0.5, costPerUnit:200000 },
