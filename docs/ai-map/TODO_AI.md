...
- E5/E6 status: not safe to complete as one-shot work. Current scan shows 204 inline handlers and 31 local classic scripts after E5.7. Replace handlers one island at a time with mobile QA; keep root `commonjs` until a separate package strategy sprint.
